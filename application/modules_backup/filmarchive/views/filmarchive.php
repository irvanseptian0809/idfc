                ...
                <div class="row row-list row-archive">
                            ...
                            <table class="text-center table-choice-archive">
                                <tr>
                                    <td style="width:16.7%" class="div-choice-archive">
                                        <a href="<?php echo base_url().'filmarchive/index/all/'.$rangedefault?>">
                                        ...
                                        <a href="<?php echo base_url().'filmarchive/index/all/'.$rangedefault?>" class="link-category <?php if($category=='all'){ echo 'active'; }?>">Semua Kategori</a>
                                    </td>
                                    <td style="width:16.7%" class="div-choice-archive">
                                        <a href="<?php echo base_url().'filmarchive/index/1/'.$rangedefault?>">
                                        ...
                                        <a href="<?php echo base_url().'filmarchive/index/1/'.$rangedefault?>" class="link-category <?php if($category=='1'){ echo 'active'; }?>">Video Pribadi</a>
                                    </td>
                                    <td style="width:16.7%" class="div-choice-archive">
                                        <a href="<?php echo base_url().'filmarchive/index/2/'.$rangedefault?>">
                                        ...
                                        <a href="<?php echo base_url().'filmarchive/index/2/'.$rangedefault?>" class="link-category <?php if($category=='2'){ echo 'active'; }?>">Budaya</a>
                                    </td>
                                    <td style="width:16.7%" class="div-choice-archive">
                                        <a href="<?php echo base_url().'filmarchive/index/3/'.$rangedefault?>">
                                        ...
                                        <a href="<?php echo base_url().'filmarchive/index/3/'.$rangedefault?>" class="link-category <?php if($category=='3'){ echo 'active'; }?>">Pemerintahan</a>
                                    </td>
                                    <td style="width:16.7%" class="div-choice-archive">
                                        <a href="<?php echo base_url().'filmarchive/index/4/'.$rangedefault?>">
                                        ...
                                        <a href="<?php echo base_url().'filmarchive/index/4/'.$rangedefault?>" class="link-category <?php if($category=='4'){ echo 'active'; }?>">Laporan</a>
                                    </td>
                                    <td style="width:16.7%" class="div-choice-archive">
                                        <a href="<?php echo base_url().'filmarchive/index/5/'.$rangedefault?>">
                                        ...
                                        <a href="<?php echo base_url().'filmarchive/index/5/'.$rangedefault?>" class="link-category <?php if($category=='5'){ echo 'active'; }?>">Lain - Lain</a>
                                    </td>
                                </tr>
                            </table>
                            </center>
                    ...
                    <div class="col-md-12" style="margin-bottom: 30px;">
                        <div class="title-sort-input">
                            <input type="text" class="text-search" placeholder="Search Here">
                    ...
                    <div class="col-md-12">
                        ...
                        <section id="cd-timeline" class="cd-container cssanimations">
                                ...
                                <div class="cd-timeline-content">
                                    <div class="owl-theme owl-carousel" style="width:99.8%;height:192px;" id="carousel1">
                                      ...
                                      $this->db->where('category_id', '4');
                                  		$this->db->where('tahun', $firstyear+9);
                                        ...
                                        <div class="item" style="padding:0px;padding-right: 7px;">
                                            <div class="hover-element hover-element-1 wow flipInX" data-wow-delay="0.4s" data-wow-duration="0.6s" data-title-position="top,left">
                                                <div class="hover-element__initial">
                                                    <img src="<?php echo base_url().$row->cover?>">
                                                </div>
                            ...
                            <div class="cd-timeline-block">
                                <div class="cd-timeline-img cd-picture">&nbsp;</div>
                                <div class="cd-timeline-content">
                                    <div class="owl-theme owl-carousel" style="width:99.8%;" id="carousel2">
                                      <?php
                                      $this->db->where('category_id', '4');
                                      $this->db->where('tahun', $firstyear+8);
                                      $this->db->where('status', 'ACTIVE');
                                      $query = $this->db->get('film_list');
                                      foreach ($query->result() as $row){
                                      ?>
                            ...
                            <div class="cd-timeline-block">
                                <div class="cd-timeline-img cd-picture">&nbsp;</div>
                                <div class="cd-timeline-content">
                                    <div class="owl-theme owl-carousel" style="width:99.8%;" id="carousel3">
                                      <?php
                                      $this->db->where('category_id', '4');
                                      $this->db->where('tahun', $firstyear+7);
                                      $this->db->where('status', 'ACTIVE');
                                      $query = $this->db->get('film_list');
                                      foreach ($query->result() as $row){
                                      ?>
                            ...
                            <div class="cd-timeline-block">
                                <div class="cd-timeline-img cd-picture">&nbsp;</div>
                                <div class="cd-timeline-content">
                                    <div class="owl-theme owl-carousel" style="width:99.8%;" id="carousel4">
                                      <?php
                                      $this->db->where('category_id', '4');
                                      $this->db->where('tahun', $firstyear+6);
                                      $this->db->where('status', 'ACTIVE');
                                      $query = $this->db->get('film_list');
                                      foreach ($query->result() as $row){
                                      ?>
                            ...
                            <div class="cd-timeline-block">
                                <div class="cd-timeline-img cd-picture">&nbsp;</div>
                                <div class="cd-timeline-content">
                                    <div class="owl-theme owl-carousel" style="width:99.8%;" id="carousel5">
                                      <?php
                                      $this->db->where('category_id', '4');
                                      $this->db->where('tahun', $firstyear+5);
                                      $this->db->where('status', 'ACTIVE');
                                      $query = $this->db->get('film_list');
                                      foreach ($query->result() as $row){
                                      ?>
                            ...
                            <div class="cd-timeline-block">
                                <div class="cd-timeline-img cd-picture">&nbsp;</div>
                                <div class="cd-timeline-content">
                                    <div class="owl-theme owl-carousel" style="width:99.8%;" id="carousel6">
                                      <?php
                                      $this->db->where('category_id', '4');
                                      $this->db->where('tahun', $firstyear+4);
                                      $this->db->where('status', 'ACTIVE');
                                      $query = $this->db->get('film_list');
                                      foreach ($query->result() as $row){
                                      ?>
                            ...
                            <div class="cd-timeline-block">
                                <div class="cd-timeline-img cd-picture">&nbsp;</div>
                                <div class="cd-timeline-content">
                                    <div class="owl-theme owl-carousel" style="width:99.8%;" id="carousel7">
                                      <?php
                                      $this->db->where('category_id', '4');
                                      $this->db->where('tahun', $firstyear+3);
                                      $this->db->where('status', 'ACTIVE');
                                      $query = $this->db->get('film_list');
                                      foreach ($query->result() as $row){
                                      ?>
                                    ...
                                    <span class="cd-date"><?php $firstyear+3; ?></span>
                                </div>
                            </div>
                            <div class="cd-timeline-block">
                                <div class="cd-timeline-img cd-picture">&nbsp;</div>
                                <div class="cd-timeline-content">
                                    <div class="owl-theme owl-carousel" style="width:99.8%;" id="carousel8">
                                      <?php
                                      $this->db->where('category_id', '4');
                                      $this->db->where('tahun', $firstyear+2);
                                      $this->db->where('status', 'ACTIVE');
                                      $query = $this->db->get('film_list');
                                      foreach ($query->result() as $row){
                                      ?>
                            ...
                            <div class="cd-timeline-block">
                                <div class="cd-timeline-img cd-picture">&nbsp;</div>
                                <div class="cd-timeline-content">
                                    <div class="owl-theme owl-carousel" style="width:99.8%;" id="carousel9">
                                      <?php
                                      $this->db->where('category_id', '4');
                                      $this->db->where('tahun', $firstyear+1);
                                      $this->db->where('status', 'ACTIVE');
                                      $query = $this->db->get('film_list');
                                      foreach ($query->result() as $row){
                                      ?>
                            ...
                            <div class="cd-timeline-block">
                                <div class="cd-timeline-img cd-picture">&nbsp;</div>
                                <div class="cd-timeline-content">
                                    <div class="owl-theme owl-carousel" style="width:99.8%;" id="carousel10">
                                      <?php
                                      $this->db->where('category_id', '4');
                                      $this->db->where('tahun', $firstyear);
                                      $this->db->where('status', 'ACTIVE');
                                      $query = $this->db->get('film_list');
                                      foreach ($query->result() as $row){
                                      ?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
          ...
          $(".select-item-archive").click(function(){
            ...
            var url_search = '<?php echo base_url()?>filmarchive/index/'+cat+'/'+value;

    ...
    <div class="main-container transition--fade">
        <div class="col-md-12" style="padding:0;">
            <div class="owl-theme owl-carousel" id="carousel15">
                <div class="item">
                    <div class="img-src" style="background-image: url('<?php echo base_url()?>img/watchfilms/slider-home.jpg');">&nbsp;</div>
                </div>
                <div class="item">
                    <div class="img-src" style="background-image: url('<?php echo base_url()?>img/watchfilms/slider-home.jpg');">&nbsp;</div>
                </div>
            ...
            <div class="container" style="width: 100%;">
                <div class="row row-list" style="padding:0;">
                                    ...
                                    <div class="item">
                                      <?php echo $link_open?>
                                        <div class="hover-element hover-element-1 wow flipInX" <?php echo $popover?> data-wow-delay="0.4s" data-wow-duration="0.6s" data-title-position="top,left" style="cursor:pointer;" name="<?php echo $link?>">
                                            <div class="img-film hover-element__initial" style="background:url('<?php echo base_url().$row->cover?>');background-size:100% auto;width:100%;height:228px;">
                                ...
                                <div class="owl-theme owl-carousel" id="carousel2">
                                  <?php foreach ($shortfilm->result() as $row){
                                    ...
                                    <div class="item">
                                      <?php echo $link_open?>
                                        <div class="hover-element hover-element-1 wow flipInX" <?php echo $popover?> data-wow-delay="0.4s" data-wow-duration="0.6s" data-title-position="top,left" style="cursor:pointer;" name="<?php echo $link?>">
                                            <div class="img-film hover-element__initial" style="background:url('<?php echo base_url().$row->cover?>');background-size:100% auto;width:100%;height:128px;">
                                              <div class="pull-right" style="background:url('<?php echo base_url()?>images/label-harga.png');background-size:100px;width:100%;height:100%;background-position:top right;background-repeat:no-repeat;font-weight:200;font-size:0.9em;">
                                ...
                                <div class="owl-theme owl-carousel" id="carousel3">
                                  <?php foreach ($documentary->result() as $row){
                                    ...
                                    <div class="item">
                                      <?php echo $link_open?>
                                        <div class="hover-element hover-element-1 wow flipInX" <?php echo $popover?> data-wow-delay="0.4s" data-wow-duration="0.6s" data-title-position="top,left" style="cursor:pointer;" name="<?php echo $link?>">
                                            <div class="img-film hover-element__initial" rel='popover' style="background:url('<?php echo base_url().$row->cover?>');background-size:100% auto;width:100%;height:128px;">
                                              <div class="pull-right" style="background:url('<?php echo base_url()?>images/label-harga.png');background-size:100px;width:100%;height:100%;background-position:top right;background-repeat:no-repeat;font-weight:200;font-size:0.9em;">
                                                <span class="pull-right" style="-webkit-transform: rotate(47deg);-moz-transform: rotate(47deg);color:white;margin-top: 9%;width: 22%;text-align:center;">
                                                  <?php echo $harga?>
                                                </span>
                                ...
                                <div class="owl-theme owl-carousel" id="carousel8">
                                  <?php foreach ($archive->result() as $row){
                                    ...
                                    <div class="item">
                                      <?php echo $link_open?>
                                        <div class="hover-element hover-element-1 wow flipInX" <?php echo $popover?> data-wow-delay="0.4s" data-wow-duration="0.6s" data-title-position="top,left" style="cursor:pointer;" name="<?php echo $link?>">
                                            <div class="img-film hover-element__initial" rel='popover' style="background:url('<?php echo base_url().$row->cover?>');background-size:100% auto;width:100%;height:180px;">
                                              <div class="pull-right" style="background:url('<?php echo base_url()?>images/label-harga.png');background-size:100px;width:100%;height:100%;background-position:top right;background-repeat:no-repeat;font-weight:200;font-size:0.9em;">
                                                <span class="pull-right" style="-webkit-transform: rotate(47deg);-moz-transform: rotate(47deg);color:white;margin-top: 9%;width: 22%;text-align:center;">
                                                  <?php echo $harga?>
                                                </span>
                    ...
                    <div class="col-md-12 list-item-bottom">
                        <div class="col-md-12">
                            <span class="item-bottom-head pull-left">FEATU<b>RED</b></span><br>
                        </div>
                        <div class="list-featured-bottom owl-theme owl-carousel" id="carousel10">
                          <?php foreach ($featured->result() as $row){
                            ...
                            <div class="item">
                                <?php echo $link_open?>
                                  <div class="hover-element hover-element-1 wow flipInX" <?php echo $popover?> data-wow-delay="0.4s" data-wow-duration="0.6s" data-title-position="top,left" style="cursor:pointer;" name="<?php echo $link?>">
                                      <div class="img-film hover-element__initial" rel='popover' style="background:url('<?php echo base_url().$row->cover?>');background-size:100% auto;width:100%;height:285px;">
                                        <div class="pull-right" style="background:url('<?php echo base_url()?>images/label-harga.png');background-size:100px;width:100%;height:100%;background-position:top right;background-repeat:no-repeat;font-weight:200;font-size:0.9em;">
        ...
        <footer class="footer-2 text-center-xs bg--dark">
            <div class="container">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <p class="text-white" style="line-height: 20px;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,

      ...
      <section class="project-single-process">
        <div class="container" style="width: 100%;margin-top:50px;">
          <div class="row row-list text-center" style="padding-left:155px;padding-right:155px;">
            <div class="title-payment" style="padding-top:20px;">Submit Film</div>
            <div class="col-md-12 text-center">
              <div class="box-checkout" style="height:950px;">
                <div class="col-md-12">
                  <form class="form-register" method="post" style="margin:0;">
                    <div class="col-md-12">
                        <input class="input-field full-width" type="text" name="title" id="title" placeholder="Title Film" required="">
                    </div>
                    <div class="col-md-6 text-left">
                        <font style="font-size:14px;font-weight:200;color:#000;padding-left:15px;">Cover Images</font>
                        <input style="margin-top:0px;" class="input-field" type="file" name="cover" id="cover" placeholder="Cover" required="">
                    </div>
                    <div class="col-md-6 text-left">
                        <font style="font-size:14px;font-weight:200;color:#000;padding-left:15px;">Thumbnail Images</font>
                        <input style="margin-top:0px;" class="input-field" type="file" name="thumbnail" id="thumbnail" placeholder="Thumbnail">
                    </div>
                    <div class="col-md-6 text-left">
                        <font style="font-size:14px;font-weight:200;color:#000;padding-left:15px;">Trailer Path</font>
                        <input style="margin-top:0px;" class="input-field" type="file" name="cover" id="cover" placeholder="Cover" required="">
                    </div>
                    <div class="col-md-6 text-left">
                        <font style="font-size:14px;font-weight:200;color:#000;padding-left:15px;">Full Path</font>
                        <input style="margin-top:0px;" class="input-field" type="file" name="thumbnail" id="thumbnail" placeholder="Thumbnail">
                    </div>
                    <div class="col-md-6">
                        <input class="input-field" type="text" name="kota" id="kota" placeholder="Durasi (Menit)" required="">
                    </div>
                    <div class="col-md-6">
                      <select name="producer" id="producer" class="input-field">
                        <option value="">Producer</option>
                        <?php foreach ($producer->result() as $row) { ?>
                    ...
                    <div class="col-md-6">
                      <select name="genre" id="genre" class="input-field">
                        ...
                        <?php foreach ($genre->result() as $row) { ?>
                          <option value="<?php echo $row->id?>"><?php echo $row->title?></option>
                        <?php } ?>
                      </select>
                    </div>
                    ...
                    <div class="col-md-6">
                      <select name="director" id="director" class="input-field">
                        <option value="">Director</option>
                        <?php foreach ($director->result() as $row) { ?>
                          <option value="<?php echo $row->id?>"><?php echo $row->title?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="col-md-6">
                        <input class="input-field full-width" type="text" name="situs_resmi" id="situs_resmi" placeholder="Situs Resmi">
                    </div>
                    <div class="col-md-6">
                        <input class="input-field full-width" type="text" name="tahun" id="tahun" placeholder="Tahun">
                    </div>
                    <div class="col-md-12">
                        <textarea class="input-field full-width" name="informasi_dasar" id="informasi_dasar" placeholder="Informasi Dasar" required="" rows="5"></textarea>
                    </div>
                    <div class="col-md-12" style="text-align:right;padding-top:50px;">
                      <button type="submit" id="submit" class="butt butt-primary sharp" style="font-size:16px !important;width:150px;height:60px;">Submit</button>
                    </div>
                  </form>
                </div>
              </div>

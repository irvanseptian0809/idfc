                ...
                <div class="row row-list" style="padding:0;">
                    ...
                    <div class="col-md-12 <?php echo $style?>">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-10" style="padding-left: 0px;">
                                <div class="owl-theme owl-carousel" id="carousel29">
                                ...
                                <div class="costumNav3">
                                    <span class="cnav3-item prev" data-carouselid="carousel29"><span class="fa fa-chevron-left"></span></span>
                                    <span class="cnav3-item next" data-carouselid="carousel29"><span class="fa fa-chevron-right"></span></span>
                                </div>
                            </div>
                        </div>
                    </div>

<body class="scroll-assist" style="background-color:#168600;" data-reveal-selectors="section:not(.masonry):not(:first-of-type):not(.parallax)" data-reveal-timing="1000">
...
?>
    ...
    <div class="main-container transition--fade">
        <div class="col-md-12" style="padding:0;">
            ...
            ?>
                <div class="item">
                    <div class="img-src" style="margin-top:35px;background-image: url('<?php echo 'http://116.206.196.146/idfilm/public/'.$banner->image;?>');background-size:100% auto;">&nbsp;</div>
                </div>
            <?php
            }
            ?>
            ...
            <div class="container" style="width: 100%;">
                <div class="row row-list" style="padding:0;">
                    <div class="col-md-12 list-item-gray">
                        ...
                        <div id="advance-filter-content">
                            ...
                            <div class="text-left label-bold advance-filter-body" style="min-height: 420px;background-color: #56c4c6;">
                                ...
                                <div class="col-md-2">
                                    <span style="font-style:italic;" class="label-bold"><?php if($lang == "en"){?>Length<?php }else{?>Panjang<?php }?></span>
                                </div>
                                <div class="col-md-10" style="padding-bottom: 10px;">
                                    <div class="col-md-4">
                    ...
                    foreach ($all_film as $key => $value) {
                        ...
                        if($value['id'] == 2){
                    ?>
                    <div class="col-md-12 <?php echo $style?> <?php echo $feature_list?>">
                        <div class="col-md-12">
                            <div class="col-md-2">
                                <!--<span class="col-md-12 item-left-head">FEATURE</span>-->
                                <?php if($lang == "en"){?>
                                    ...
                                    <div class="item">
                                      ...
                                      <a style="cursor: pointer;" onclick="openmovie('<?php echo $row->id?>','<?php echo $row->category_id?>','<?php echo $link?>')">
                                        <div class="hover-element hover-element-1 wow flipInX" <?php echo $popover?> data-wow-delay="0.4s" data-wow-duration="0.6s" data-title-position="top,left" style="cursor:pointer;" name="<?php echo $link?>">
                                            <div class="img-film hover-element__initial" style="background:url('<?php echo $cover?>');background-color:#000;background-size:auto 100%;width:100%;height:235px;background-position:top center;background-repeat:no-repeat;">
                                              <?php if($harga <> 'FREE'){ ?>
                    ...
                    ?>
                        ...
                        <div class="col-md-12 <?php echo $style?> <?php echo $trailer_list?>">
                            <div class="col-md-12">
                                <div class="col-md-2">
                                <?php if($lang == "en"){?>
                    ...
                    ?>
                        ...
                        <div class="col-md-12 <?php echo $style?>  <?php
                        if($value['id'] == 7){
                            echo $shortfilm_list;
                        }elseif($value['id'] == 9){
                            echo $documentary_list;
                        }elseif($value['id'] == 8){
                            echo $commercial_list;
                        }elseif($value['id'] == 6){
                            echo $music_video_list;
                        }elseif($value['id'] == 1){
                            echo $animation_list;
                        }elseif($value['id'] == 4){
                            echo $archive_list;
                        ...
                        ?>">
                            <div class="col-md-12">
                                <div class="col-md-2">
                                    ...
                                    ?>
                                        <?php if($lang == "en"){?>
                                        <span class="col-md-12 item-left-head">Michael Rogge</span>
                                        <span class="col-md-12 item-left-desc">Collection</span><br>
                                        <?php }else{?>
                                        <span class="col-md-12 item3-left-head" style="font-size: 25px">Michael Rogge</span>
                                        <span class="col-md-12 item3-left-desc" style="font-size: 35px">Collection</span><br>
                                        <?php }?>
                                    <?php
                                    }else{
                                    ?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
             // alert('Menyambut hari raya Idul Fitri 1439 H, kantor kami akan tutup pada 13 Juni 2018 - 20 Juni 2018, seluruh pesanan pada waktu tersebut  prosesnya  akan kami lakukan pada saat kantor kami buka kembali. \n\nDuring Idul Fitri 1439 H holidays, our office will be closed from 13 June 2018 until 20 June 2018. All orders placed during that period will be processed after our office has re-opened');
           ...
           $('body').popover({
            ...
            $(".btn-apply-filter").click(function(){
              ...
              var checkboxes = document.getElementsByName('categories');
              var categories = "C";
              var loop_checkboxes = 0;
              for (var i=0, n=checkboxes.length;i<n;i++)
              {
                  if (checkboxes[i].checked)
                  {
                       loop_checkboxes++
                       var check_count_category = loop_checkboxes;
                       var Kategorinya = checkboxes[i].value;
                      categories += "-"+checkboxes[i].value;
                  }
              }
              ...
              for (var i=0, n=checkboxes4.length;i<n;i++)
              {
               ...
               if(check_count_category == 1){
                    var url_search = '<?php echo base_url()?>watchfilms/category/'+Kategorinya+'/0/'+text+'/P/'+year_start+'-'+year_end+'/'+length+'/'+genre;
               }else{
                    var url_search = '<?php echo base_url()?>watchfilms/index/'+text+'/'+categories+'/'+paid+'/'+year_start+'-'+year_end+'/'+length+'/'+genre;
               }
              window.location = url_search;
...
<div class="modal fade" id="myModal" role="dialog" style="width:1000px;top:7%;left:10%;overflow-y: hidden;">
    <div class="modal-dialog" style="width: 100%;margin: auto;">
       <!-- Modal content-->
       <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body" style="padding:20px;">
                 Menyambut hari raya Idul Fitri 1439 H, kantor kami akan tutup pada 13 Juni 2018 - 20 Juni 2018, seluruh pesanan pada waktu tersebut  prosesnya  akan kami lakukan pada saat kantor kami buka kembali.
                 <br><br>During Idul Fitri 1439 H holidays, our office will be closed from 13 June 2018 until 20 June 2018. All orders placed during that period will be processed after our office has re-opened
            </div>
            <div class="modal-footer">
                <div class="col-md-12">
                    <button id="stop-movie" type="button" class="butt butt-primary sharp" data-dismiss="modal" style="font-size:12px !important;height:30px;width:100px;margin-bottom:2px;">Close</button>

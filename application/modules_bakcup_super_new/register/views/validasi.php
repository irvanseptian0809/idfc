    ...
    <div class="main-container transition--fade" style="background-color:#efefef;">
      <section class="project-single-process">
        <div class="container" style="width: 100%;margin-top:50px;">
          ...
          <div class="arrow-register" style="margin-top:450px;">
            <div class="title-arrow">
          ...
          <div class="row row-list text-center" style="padding-left:155px;padding-right:155px;">
            <div class="col-md-12 text-center">
              <div class="box-checkout" style="height:750px;">
                <div class="col-md-12">
                  <form class="form-register" action="<?php echo site_url()?>" method="post">
                    <div class="col-md-12" style="padding-top:25px;padding-right:40px;text-align:left;height:400px;">
                      <h5>Selamat Akun anda telah berhasil didaftarkan, Silahkan login / masuk dengan data anda.</h5>
                    </div>
                    ...
                    <div class="col-md-6" style="text-align:right;padding-top:25px;padding-right:40px;">
                      <button type="submit" id="bayar" class="butt butt-primary sharp" style="font-size:16px !important;width:150px;height:60px;">Home Page</button>
                    </div>
                  </form>
                </div>
              </div>

    ...
    <div class="main-container transition--fade" style="background-color:#efefef;">
      <section class="project-single-process">
        <div class="container" style="width: 100%;margin-top:50px;">
          ...
          <div class="arrow-register" style="margin-top:150px;">
            <div class="title-arrow">
              Langkah 2<br>Informasi
            </div>
          </div>
          <div class="arrow-register gray-arrow" style="margin-top:300px;">
            <div class="title-arrow">
          ...
          <div class="row row-list text-center" style="padding-left:155px;padding-right:155px;">
            <div class="col-md-12 text-center">
              <div class="box-checkout" style="height:750px;">
                <div class="col-md-12">
                  <form class="form-register" action="<?php echo site_url('register/konfirmasi')?>" method="post">
                    ...
                    <div class="col-md-12" style="padding-top:25px;padding-right:40px;text-align:left;height:400px;">
                      <h5>Berikut adalah Informasi Akun anda, kode verifikasi dikirimkan ke email anda.</h5><br>
                      <table width="60%" style="font-weight:300;">
                        <tr>

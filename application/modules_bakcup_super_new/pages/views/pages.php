      ...
      <section class="project-single-process">
        <div class="container" style="width: 100%;margin-top:50px;">
          <div class="row row-list text-center" style="padding-left:155px;padding-right:155px;">
            <div class="title-payment" style="padding-top:20px;"><?php echo $value;?></div>
            <div class="col-md-12 text-center">
              <div class="box-checkout">
               <div class="row">
                <div class="col-md-12" style="text-align:left;list-style-type:decimal;">
                    <?php
                         if($kostum == "no"){
                              echo $konten[0]->konten;
                         }else{
                              echo $konten;
                         }
                    ?>

                    <?php if($param == "kontak" || $param == "kontak_eng"){?>
                         <form action="<?php echo base_url()."pages/send_kontak"?>" method="post">
                              <div class="col-md-12" style="padding:10px 0;">
                                   <div class="col-md-3">
                                        <p style="font-size:15;font-weight:500;">Select Category</p>
                                   </div>
                                   <div class="col-sm-9">
                                        <select class="this_border" name="kategori" style="padding:10px;width:100%;">
                              ...
                              <div class="col-md-12" style="padding:10px 0;">
                                   <div class="col-md-3">
                                        <p style="font-size:15;font-weight:500;">Select Section</p>
                                   </div>
                                   <div class="col-sm-9">
                                        <select class="this_border" name="section" style="padding:10px;width:100%;">
                                             <option value="General IdFilmCenter">General IdFilmCenter</option>
                                             <option value="WatchFilms">WatchFilms</option>
                                             <option value="FilmInfo">FilmInfo</option>
                                             <option value="FilmArchive">FilmArchive</option>
                                             <option value="FilmNews">FilmNews</option>
                                             <option value="FilmBlog">FilmBlog</option>
                                        </select>
                                   </div>
                              </div>
                              ...
                              <div class="col-md-12" style="padding:10px 0;">
                                   <div class="col-md-3">
                                        <p style="font-size:15;font-weight:500;">Subject</p>
                                   </div>
                                   <div class="col-sm-9">
                                        <input class="this_border" name="subject" placeholder="Subject" style="padding:10px;width:100%;"/>
                                   </div>
                              </div>

                              <div class="col-md-12" style="padding:10px 0;">
                                   <div class="col-md-3">
                                        <p style="font-size:15;font-weight:500;">Message</p>
                                   </div>
                                   <div class="col-sm-9">
                                        <textarea  class="this_border" name="message" placeholder="Message" style="padding:10px;width:100%;height:200px;"></textarea>
                                   </div>
                              </div>

                              <div class="col-md-12" style="padding:10px 0;">
                                   <div class="col-md-3">
                                        <p style="font-size:15;font-weight:500;">Please fill in your e-mail address:</p>
                                   </div>
                                   <div class="col-sm-9">
                                        <input class="this_border" name="email" placeholder="Email" style="padding:10px;width:100%;"/>
                                   </div>
                              </div>

                              <div class="col-md-12" style="padding:10px 0;">
                                   <button class="btn btn-danger" style="float:right;" type="submit" style="width:100px!important;">Send</button>
                              </div>

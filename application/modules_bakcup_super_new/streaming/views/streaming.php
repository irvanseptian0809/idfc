      ...
      <section class="project-single-process">
        <div class="container" style="width: 100%;margin-top:50px;">
          <div class="row row-list text-center" style="padding-left:155px;padding-right:155px;">
            <div class="title-payment" style="padding-top:20px;">Katalog</div>
            <div class="col-md-12 text-center">
              <div class="box-checkout" style="height:750px;">
                <div class="col-md-12">

                     <form class="form-register" action="<?php echo base_url()."streaming/code"?>" method="post" style="margin:0;">

                         <div class="col-md-12">
                              <div style="text-align:left">Silakan masukkan kode akses Anda di sini</div>
                              <input class="input-field full-width" type="text" name="kode" id="kode" placeholder="Kode Akses" required="">
                         </div>

                       <div class="col-md-12" style="text-align:right;padding-top:25px;padding-right:40px;">
                         <button type="submit" id="bayar" class="butt butt-primary sharp" style="font-size:16px !important;width:150px;height:60px;">Submit</button>
                       </div>
                     </form>

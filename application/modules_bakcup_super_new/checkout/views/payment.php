<body class="scroll-assist" data-reveal-selectors="section:not(.masonry):not(:first-of-type):not(.parallax)" data-reveal-timing="1000">
      ...
      <section class="project-single-process">
              ...
              <div class="box-checkout row">
                <div class="col-md-12">
                  <form class="form-register" method="post" style="margin:0;">
                    ...
                    <div class="col-md-12">
                        <input class="input-field full-width" type="text" name="email" id="email" placeholder="Email" required="">
                    </div>

                    <div class="col-md-12">
                        <input class="input-field full-width" type="text" name="phone" id="phone" placeholder="Telepon" required="">
                    </div>
               ...
               ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <!--<select class="input-field" name="kota" id="kota" style="height: 56px">
                            <option name="negara" id="negara">asdfasdfasd</option>
                        </select>-->
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12" style="text-align:left">
                         <span style="padding-left:30px;">Pilih Metode Pembayaran</span>
                         <select class="input-field full-width" name="metode_pembayaran" id="metode_pembayaran">
                    ...
                    <div class="col-md-12">
                         <a class="btn butt butt-primary sharp btn_shipping" style="font-size:16px !important;" id="shipping_option">Shipping Option</a>
                         <input type="hidden" name="shipping_select" id="shipping_select" value="">
                    </div>

                    <div class="col-md-12" id="this_invoice" style="display:none;">
                         <div style="padding:20px 0;">
                              <div style="padding:10px 25px;background-color:#d30e0e;color:white;text-align:left;border:2px solid #d30e0e">
                                   <div style="">Invoice</div>
                              </div>

                              <div style="border:2px solid #d30e0e;padding:10px 35px;text-align:left">

                                   <div class="row">
                                        <div class="col-md-6">
                                             Kurs hari ini adalah
                                        </div>
                                        <div class="col-md-6">
                                             :&nbsp&nbsp&nbsp&nbsp&nbsp
                                             IDR <?php echo number_format($kurs)?> = USD 1
                                        </div>
                                   </dov>
                                   ...
                                   <div class="row">
                                        <div class="col-md-6">
                                             <?php echo $row->title?> ( <?php echo $row->type?> : <?php echo $row->count?> )
                                        </div>
                                        <div class="col-md-6">
                                             :&nbsp&nbsp&nbsp&nbsp&nbsp
                                             <?php
                                             ...
                                             <span class="idr_price">
                                                  <?php
                                                  echo "IDR ";
                                                  echo number_format($get_price[0]->price * $row->count);
                                                  echo " ( USD ";
                                                  echo round(($get_price[0]->price * $row->count)/$kurs,2)." )";
                                                  ?>
                                             </span>

                                             <span class="usd_price" style="display:none;">
                                                  <?php
                                                  echo "IDR ";
                                                  echo number_format($get_price[0]->price * $row->count);
                                                  ?>
                                   ...
                                   <input type="hidden" name="kurs" id="kurs" value="<?php echo $kurs?>">
                                   <input type="hidden" name="kurir_harga" id="kurir_harga" value="">

                                   <div class="row">
                                        <div class="col-md-6" id="shipping_invoice">
                                             Nomor Inoice
                                        </div>
                                        <div class="col-md-6" id="harga_shipping_invoice">
                                             :&nbsp&nbsp&nbsp&nbsp&nbsp
                                        </div>
                                   </div>
                                   ...
                                   <div class="row" style="margin-top:50px;">
                                        ...
                                        <div class="col-md-6" id="total_bayar">
                                             :&nbsp&nbsp&nbsp&nbsp&nbsp
                                             <?php echo $invoice?>
                                        </div>
                                   </div>
               ...
               <?php }?>
                    <!--<div class="col-md-12">
                        <input class="input-field" type="text"  placeholder="Negara" required="">
                        <select class="input-field" name="shipping">
                            <option name="negara" id="negara">asdfasdfasd</option>
                        </select>
                    </div>
                    <div class="col-md-6">
        ...
        <footer class="footer-2 text-center-xs bg--dark">
            <div class="container">
                ...
                <div class="col-md-12">
                    <div class="col-md-4">
                        <p class="text-white" style="line-height: 20px;"><?php
    ...
    <!-- MODAL -->
    <div class="modal fade" id="popup" role="dialog" style="width:1000px;top:7%;left:10%;overflow-y: hidden;">
                         ...
                         <table class="table table-bordered">
                               ...
                               <tbody id="isi_shipping">
                                 <tr>
                                   ...
                                   <td>14.40</td>
                                   <td>5</td>
                                   <td><a class="pilihlahaku" onclick="pilihlah(2)">Pilih</a></td>
                                 </tr>
                               </tbody>
                         </table>
                         </div>

                         <h4 id="gagal_shipping"></h4>
    ...
    <script type="text/javascript">
          ...
          function pilihlah(id){
               ...
               $.ajax({
                    type : 'POST',
                    url : '<?php echo site_url('checkout/get_courier_name')?>/'+id+'/'+total_harga+'/'+kurs,
                    success:function(data){
                        ...
                        if (tmp.success == "true"){
                             ...
                             /*document.getElementById('kurir_harga').value=tmp.harga;
                             var total_harga = $("#total_harga").val();
                             var kurs = $("#kurs").val();
                             var harga_kurir = $("#kurs").val();

                             var kurs_total = total_harga / kurs;
                             var kurir_harga = parseInt(tmp.harga);
                             if(tmp.kota != '0' ){
                                  var jumlah_harga = total_harga + harga_kurir;
                                  var kurs_total = jumlah_harga / kurs;
                                  var total_harga_format = jumlah_harga.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,");
                                  $("#total_bayar").html(':&nbsp&nbsp&nbsp&nbsp&nbsp IDR '+total_harga_format+' (USD '+kurs_total.toFixed(2)+')');
                             }else{
                                  var kurs_total = total_harga / kurs;
                                  kurs_total = kurs_total + harga_kurir;
                                  $("#total_bayar").html(':&nbsp&nbsp&nbsp&nbsp&nbsp USD '+kurs_total);
                             }
                             */
        ...
        $(document).ready(function(){
          $(".btn_shipping").click(function(){
               ...
               if(kota == "" || propinsi == "" || negara == ""){
                    $("#gagal_shipping").html('Kami membutuhkan alamat lengkap, termasuk nama Kota, Propinsi dan Negara, untuk memberi pilihan jenis pengiriman untuk Anda.');
                    document.getElementById( 'info_shipping' ).style.display = 'none';
                    document.getElementById( 'gagal_shipping' ).style.display = 'block';
               }else{
                    ...
                    $.ajax({
                         type : 'POST',
                         url : '<?php echo site_url('checkout/shipping')?>/'+payment_id+'/'+kota+'/'+propinsi+'/'+negara,
                         success:function(data){
                             var tmp = eval('('+data+')');
                             if (tmp.success == "true"){
                                  $("#isi_shipping").html(tmp.isi);
                             }else{
                                 alert("failed");
                             }
                         }
                    ...
                    document.getElementById( 'gagal_shipping' ).style.display = 'none';
               }
             $('#popup').modal('show');
          });
            ...
            $.ajax({
              ...
              success:function(data){
                ...
                if (tmp.success){
                  ...
                  //window.location = "<?php echo site_url('checkout/payment_detail/'.$payment_id)?>";
                  window.location = tmp.redirect;
                }else{
                  alert("Failed");
                }
              }

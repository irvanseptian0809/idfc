      ...
      <section class="project-single-process">
        <div class="container" style="width: 100%;margin-top:50px;">
          <div class="row row-list text-center" style="padding-left:155px;padding-right:155px;">
            <div class="title-payment" style="padding-top:20px;">Metode Pembayaran</div>
            <div class="col-md-12 text-center">
              <div class="box-checkout" style="height:750px;">
                <div class="col-md-12">
                <?php echo validation_errors(); ?>
                  <form class="form-horizontal" action="<?php echo base_url()."checkout/payment_methode/".$id?>" method="post">

                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <p style="text-align: right;padding: 5px 20px;">Nama Dikirim</p>
                        </div>
                        <div class="col-sm-6">
                            <p style="text-align: left;padding: 5px 20px;">: <?php echo $data[0]->destination_name?></p>
                        </div>
                    </div>

                    <div class="col-sm-12" style="border-bottom: 1px solid #b4b4b4"></div>

                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <p style="text-align: right;padding: 5px 20px;">Alamat Dikirim</p>
                        </div>
                        <div class="col-sm-6">
                            <p style="text-align: left;padding: 5px 20px;">: <?php echo $data[0]->destination_address?></p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <p style="text-align: right;padding: 5px 20px;">Kota</p>
                        </div>
                        <div class="col-sm-6">
                            <p style="text-align: left;padding: 5px 20px;">: <?php echo $data[0]->kota?></p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <p style="text-align: right;padding: 5px 20px;">Provinsi</p>
                        </div>
                        <div class="col-sm-6">
                            <p style="text-align: left;padding: 5px 20px;">: <?php echo $data[0]->propinsi?></p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <p style="text-align: right;padding: 5px 20px;">Kode Pos</p>
                        </div>
                        <div class="col-sm-6">
                            <p style="text-align: left;padding: 5px 20px;">: <?php echo $data[0]->kodepos?></p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <p style="text-align: right;padding: 5px 20px;">Negara</p>
                        </div>
                        <div class="col-sm-6">
                            <p style="text-align: left;padding: 5px 20px;">: <?php echo $data[0]->negara?></p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <p style="text-align: right;padding: 5px 20px;">No Telepon</p>
                        </div>
                        <div class="col-sm-6">
                            <p style="text-align: left;padding: 5px 20px;">: <?php echo $data[0]->phone?></p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            <p style="text-align: right;padding: 5px 20px;">Pembayaran</p>
                        </div>
                        <div class="col-sm-6">
                            <select name="metode" class="form-control" style="width:unset;float: left;margin: 5px 20px;" required>

...
<body class="scroll-assist" style="background-color:#fef552;" data-reveal-selectors="section:not(.masonry):not(:first-of-type):not(.parallax)" data-reveal-timing="1000">
    ...
    $(document).ready(function(){
        $(document).on('click','.show_more',function(){
            ...
            $.ajax({
                type:'POST',
                url:'<?php echo base_url()."filmblog/see_more"?>',
                data:{no:no},
                ...
                <div class="container" style="padding-left:20px;padding-right:20px;">
                    ...
                    <div class="row">
                        ...
                        <div class="tutorial_list">
                            ...
                            <article class="post post-list <?php echo $type?>" style="margin-bottom:20px;">
                                ...
                                <div class="post-head">
                                    ...
                                    <div class="post-head-left">
                                        ...
                                        <div class="post-meta">
                                            <a href="<?php echo site_url('filmblog/detail/'.url_title(strtolower($row->title)).'/'.$row->id)?>"><i class="fa fa-comment"></i> <?php echo $comments?></a>
                                            <?php if($row->tag != ''){ ?>
                            ...
                            <!-- Pagination -->
                            <div class="col-md-12">
                            <?php if(count($jum_film_blog->result()) > 5){?>
                                <div class="show_more_main" id="show_more_main5">
                                        <input type="hidden" class="more_search" value="<?php if(isset($hasil_pencarian) && $no == 1){
                        ...
                        <aside class="col-md-3 sidebar right-sidebar" style="padding-left:20px;position: sticky;top: 70px;">
                            <div class="widget sidebar-widget popular-post-widget">
                              ...
                              <form action="<?php echo base_url()?>filmblog/search" method="post">
                                <div class="wrap">
                                  <div class="search">
                                    <input type="text" name="key" class="searchTerm" placeholder="What are you looking for?" value="<?php if(isset($hasil_pencarian)){echo $hasil_pencarian;}?>">

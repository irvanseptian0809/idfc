          ...
          <div class="row row-list" style="padding-left:55px;padding-right:55px;">
            <div class="col-md-9" style="margin-top: 100px;">
              ...
              foreach ($film_news->result() as $row){
                $no++;
                $mod = $no % 5;
                $exps = explode('/',$row->sumber); ?>
              <div class="box-news">
                <div class="col-md-4" style="padding:5px;">
                  <img src="<?php echo 'http://116.206.196.146/'."images/filmnews/".$row->cover?>" alt="<?php echo $row->title?>" width="100%">
                </div>
                <div class="col-md-8">
                  <div class="desc-news" style="color:black;line-height:20px !important;font-weight:250;">
                    <?php echo $exps[2]?>
                  </div>
                  <div class="title-news"><?php echo $row->title?></div>
                  <div class="date-news" style="color:black;"><?php echo date('d F Y', strtotime($row->news_date))?></div>
                  <div class="desc-news" style="color:black;line-height:20px !important;font-weight:200;"><?php echo $row->description?></div>
                  <div class="more-news" style="color:black;"><a href="<?php echo $row->sumber?>" target="_blank">Selengkapnya >></a></div>
                </div>
                <div class="clearfix"></div>
              </div>
              <?php if($mod==0){ ?>
              <div class="box-news" style="height:80px;">
                <div class="col-md-12">
            ...
            <div class="col-md-3" style="margin-top:100px;">
              ...
              $query = $this->db->get('film_event_location');
              foreach ($query->result() as $location){
              ?>
              <div class="desc-agenda" style="color:black;">
                <?php echo date("j F Y", strtotime($location->event_date))." ".$location->time?><br>

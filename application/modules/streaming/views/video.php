      ...
      <section class="project-single-process">
        <div class="container" style="width: 100%;margin-top:50px;">
          <div class="row row-list text-center" style="padding-left:155px;padding-right:155px;">
            <div class="title-payment" style="padding-top:20px;">Streaming</div>
            <div class="col-md-12 text-center">
              <div class="box-checkout">
                 ...
                 <div class="row">
                <div class="col-md-12 bg-film">

                          <video id="path-movie" class="video-js" controls controlsList="nodownload" preload="auto" style="width:100%;" height="420"
                          poster="" data-setup="{}">
                          <source id="trailer-source" src="<?php echo "http://116.206.196.146/".$video?>" type='video/mp4'>
                          <p class="vjs-no-js">
           ...
           <div class="row">
                <div class="col-md-12">
                     <div style="text-align:left;font-size:20px;padding:20px;background:#f4f4f4;border:2px solid red;">
                          <input type="hidden" value="<?php echo $invoice?>" id="invoice" name="invoice">
                          <span id="countdown" class="timer"></span>
                     </div>
                    <script>
                    var upgradeTime = <?php echo $waktu?>;
                    ...
                    function timer() {
                        ...
                        document.getElementById('upgradeTime').innerHTML = seconds;
                        var invoice = $("#invoice").val();
                        $.ajax({
                             type : 'POST',
                             url : '<?php echo site_url('streaming/update_waktu')?>/'+invoice+'/'+seconds+'',
          ...
          <div class="row" style="padding-top:60px;">
               <div class="col-md-12">
                    ...
                    <div class="col-md-12" style="text-align:left">
                         <div class="row">
                         <div class="col-md-4">
                              <p style="text-align:justify;color:black;font-weight: 100;">
                                   <b>Producer</b>
                              </p>
                         </div>
                         <div class="col-md-8">
                              <?php
                              $get = $this->db->select("*")->from("film_castcrew")->where("film_id",$film[0]->id)->where("film_castcrew_position_id","68")->get()->result();

                              if(!empty($get)){
                                   foreach($get as $row) {
                                   $profile = $this->db->select("nama")->from("profiles")->where("id",$row->profile_id)->get()->result();
                                        if(!empty($profile)){
                              ?>
                                             <p style="text-align:justify;color:black;font-weight: 100;">
                                                  <?php echo $profile[0]->nama;?>
                                             </p>
                              <?php
                                        }
                                   }
                    ...
                    <div class="col-md-12" style="text-align:left">
                         ...
                         <div class="col-md-8">
                              <?php
                              $get = $this->db->select("*")->from("film_castcrew")->where("film_id",$film[0]->id)->where("film_castcrew_position_id","69")->where("position_name !=","")->get()->result();
                    ...
                    <div class="col-md-12" style="text-align:left">
                         ...
                         <div class="col-md-8">
                              <?php
                              $get = $this->db->select("*")->from("film_castcrew")->where("film_id",$film[0]->id)->where("film_castcrew_position_id","66")->where("position_name !=","")->get()->result();
                    ...
                    <div class="col-md-12" style="text-align:left">
                         ...
                         <div class="col-md-8">
                              <?php
                              $get = $this->db->select("*")->from("film_castcrew")->where("film_id",$film[0]->id)->where("film_castcrew_position_id","2")->where("position_name !=","")->get()->result();
                    ...
                    <div style="padding:1px;background:black;margin:20px 0;"></div>

                    <h5 style="text-align:left"><b>Sinopsis Lengkap:</b></h5>
                    <p style="text-align:justify;color:black;font-weight: 100;">
                         <?php echo nl2br($film[0]->fullsynopsis_ind);?>
                    </p>

                    <a target="_blank" href="<?php echo base_url()."/detail/index/streaming/".$film[0]->id;?>" style="text-align:right;">
                         <p style="font-size:21px;font-weight:100">Informasi</p>
                    </a>

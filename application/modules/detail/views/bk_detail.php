        ...
        <div class="main-container transition--fade">
                ...
                <div class="container filminfo-detail-container" style="width: 100%;">
                    ...
                    <?php if($film->category_id <> '6' and $film->category_id <> '8' and $film->category_id <> '10'){ ?>
                        <div class="col-md-4" style="padding-bottom: 20px;padding-right: 0px;width:294px;">
                            ...
                            <?php }else{ ?>
                            <img src="<?php echo 'http://116.206.196.146/'?><?php echo $film->cover?>">
                            <?php } ?>
                        ...
                        <div class="col-md-8 detail-desc-film">
                            <div class="col-md-12" style="padding-left: 0px;padding-right: 0px;">
                                ...
                                <div class="col-md-4" style="padding-left: 0px;">
                                    ...
                                    $this->db->where('film_castcrew.position', '40');
                                    $crew = $this->db->get();
                                    foreach ($crew->result() as $cast){
                                    ?>
                                    <a href="<?php echo site_url('profil/index/producer/'.$cast->profile_id)?>"><?php echo $cast->nama?></a>
                            ...
                            <div class="col-md-12" style="padding-top: 10px;padding-bottom: 10px;padding-left: 0px;">
                                ...
                                <div class="col-md-4" style="padding-left: 0px;">
                                    ...
                                    $this->db->join('profiles', 'profiles.id = film_castcrew.profile_id');
                                    $this->db->where('film_castcrew.film_id', $film_id);
                                    $this->db->where('film_castcrew.position', '42');
                                    $crew = $this->db->get();
                                    foreach ($crew->result() as $cast){
                                    ?>
                            ...
                            <div id="accordion" class="accordion red">
                                <div class="accordion-item" id="accordion-item1">
                                    ...
                                    <div class="accordion-content" id="accordion-content1">
                                        ...
                                        <span class="desc-film"><?php echo $film->briefsynopsis_ind?></span>
                                        <br><br>
                                        <span class="title-film">Sinopsis Lengkap: </span><br>
                                        <span class="desc-film"><?php echo $film->fullsynopsis_ind?></span>
                                        <br><br>
                                        <?php
                                        ...
                                        <span class="desc-film"><?php echo $negarafilm.", ".tanggal_indo(date('Y-m-d', strtotime($film->created_at)))?></span>
                                    </div>
                                </div>
                                    ...
                                    <div class="accordion-content" id="accordion-content2">
                                        <div class="col-md-6">
                                            ...
                                            <span class="desc-film">
                                                <a href="<?php echo site_url('profil/index/producer/'.$cast->profile_id)?>">
                                                    <?php echo $cast->nama?>
                                                </a>
                                            </span><br>
                                            <?php 
                                            }
                                            if($crew->num_rows() > 0){ echo "<br><br>"; } 
                                            ?>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            $this->db->join('profiles', 'profiles.id = film_castcrew.profile_id');
                                            $this->db->where('film_castcrew.film_id', $film_id);
                                            $this->db->where('film_castcrew.position', '44');
                                            $crew = $this->db->get();
                                            foreach ($crew->result() as $cast){
                                            ?>
                                            <span class="desc-film">
                                                <a href="<?php echo site_url('profil/index/scriptwriter/'.$cast->profile_id)?>">
                                                    <?php echo $cast->nama?>
                                                </a>
                                            </span><br>
                                            <?php 
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            $this->db->join('profiles', 'profiles.id = film_castcrew.profile_id');
                                            $this->db->where('film_castcrew.film_id', $film_id);
                                            $this->db->where('film_castcrew.position', '36');
                                            $crew = $this->db->get();
                                            foreach ($crew->result() as $cast){
                                            ?>
                                            <span class="desc-film">
                                                <a href="<?php echo site_url('profil/index/maincast/'.$cast->profile_id)?>">
                                                <?php 
                                                if($cast->charactername<>'' and $cast->charactername<>'0') { 
                                                    echo $cast->nama." (Sebagai ".$cast->charactername.")";
                                                }else{
                                                    echo $cast->nama;
                                                } 
                                                ?>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            $this->db->join('profiles', 'profiles.id = film_castcrew.profile_id');
                                            $this->db->where('film_castcrew.film_id', $film_id);
                                            $this->db->where('film_castcrew.position', '37');
                                            $crew = $this->db->get();
                                            foreach ($crew->result() as $cast){
                                            ?>
                                            <span class="desc-film">
                                                <a href="<?php echo site_url('profil/index/supportingcast/'.$cast->profile_id)?>">
                                                <?php 
                                                if($cast->charactername<>'' and $cast->charactername<>'0') { 
                                                    echo $cast->nama." (Sebagai ".$cast->charactername.")";
                                                }else{
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            $this->db->join('profiles', 'profiles.id = film_castcrew.profile_id');
                                            $this->db->where('film_castcrew.film_id', $film_id);
                                            $this->db->where('film_castcrew.post_type', 'crew');
                                            $crew = $this->db->get();
                                            foreach ($crew->result() as $cast){
                                            ?>
                                            <span class="desc-film">
                                                <div class="col-md-6">
                                                    <a href="<?php echo site_url('profil/index/crew/'.$cast->profile_id)?>"><?php echo $cast->nama?></a>
                                                </div>
                                                <div class="col-md-6">
                                ...
                                <div class="accordion-item" id="accordion-item3">
                                    ...
                                    <div class="accordion-content" id="accordion-content3">
                                        ...
                                        <span class="desc-film">
                                            <?php if($film->cover<>''){ ?>
                                            <a href="<?php echo 'http://116.206.196.146/'.$film->cover?>" rel="prettyPhoto" style="text-decoration: none;">  
                                                <img src="<?php echo 'http://116.206.196.146/'.$film->cover?>" height="100" style="padding-bottom:4px;" />
                                            </a>
                                            <?php } ?>
                                            <?php if($film->thumbnail_1<>''){ ?>
                                            <a href="<?php echo 'http://116.206.196.146/'.$film->thumbnail_1?>" rel="prettyPhoto" style="text-decoration: none;">  
                                                <img src="<?php echo 'http://116.206.196.146/'.$film->thumbnail_1?>" height="100" style="padding-bottom:4px;" />
                                            </a>
                                            <?php } ?>
                                            <?php if($film->thumbnail_2<>''){ ?>
                                            <a href="<?php echo 'http://116.206.196.146/'.$film->thumbnail_2?>" rel="prettyPhoto" style="text-decoration: none;">  
                                                <img src="<?php echo 'http://116.206.196.146/'.$film->thumbnail_2?>" height="100" style="padding-bottom:4px;" />
                                            </a>
                                            <?php } ?>
                                            <?php if($film->thumbnail_3<>''){ ?>
                                            <a href="<?php echo 'http://116.206.196.146/'.$film->thumbnail_3?>" rel="prettyPhoto" style="text-decoration: none;">  
                                                <img src="<?php echo 'http://116.206.196.146/'.$film->thumbnail_3?>" height="100" style="padding-bottom:4px;" />
                                            </a>
                                            <?php } ?>
                                            <?php if($film->thumbnail_4<>''){ ?>
                                            <a href="<?php echo 'http://116.206.196.146/'.$film->thumbnail_4?>" rel="prettyPhoto" style="text-decoration: none;">  
                                                <img src="<?php echo 'http://116.206.196.146/'.$film->thumbnail_4?>" height="100" style="padding-bottom:4px;" />
                                            </a>
                                            <?php } ?>
                                            <?php if($film->thumbnail_5<>''){ ?>
                                            <a href="<?php echo 'http://116.206.196.146/'.$film->thumbnail_5?>" rel="prettyPhoto" style="text-decoration: none;">  
                                ...
                                <div class="accordion-item" id="accordion-item4">
                                    ...
                                    <div class="accordion-content" id="accordion-content4">
                                        <span class="title-film">
                                            <div class="col-md-4">Lokasi</div>
                                            <div class="col-md-4">Festival</div>
                                        ...
                                        <span class="desc-film">
                                            ...
                                            ?>
                                            <div class="col-md-4"><?php echo $award->location?></div>
                                            <div class="col-md-4"><?php echo $award->festival?></div>
                                            <div class="col-md-4"><?php echo $award->award?></div>
                                            <?php } ?>
                                            <div class="clearfix"></div>
                                        </span>
                                    </div>
            ...
            <footer class="footer-2 text-center-xs bg--dark">
                <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-4">
                            <p class="text-white" style="line-height: 20px;padding-right:30px;text-align:justify;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <video id="trailer-video" class="video-js" controls autoplay preload="auto" width="597" height="420"
                        poster="<?php echo 'http://116.206.196.146/'.$film->thumbnail_1?>" data-setup="{}">
                        <source id="trailer-source" src="<?php echo 'http://116.206.196.146/'.$film->full_path_hd?>" type='video/mp4'>
                        <p class="vjs-no-js">
                            To view this video please enable JavaScript, and consider upgrading to a web browser that
                            <a href="http://videojs.com/html5-video-support/" target="_blank">supports HTML5 video</a>
                        </p>
        ...
        <div class="modal fade" id="popup-behind" role="dialog" style="width:700px;top:7%;left:27%;">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php if($film->behindthescene_path_hd <> ''){ ?>
                        <video id="behind-video" class="video-js" controls autoplay preload="auto" width="597" height="420"

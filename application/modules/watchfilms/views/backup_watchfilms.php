<body class="scroll-assist" data-reveal-selectors="section:not(.masonry):not(:first-of-type):not(.parallax)" data-reveal-timing="1000">
    ...
    <div class="main-container transition--fade">
        <div class="col-md-12" style="padding:0;">
            <div class="owl-theme owl-carousel" id="carousel15">
                <div class="item">
                    <div class="img-src" style="background-image: url('<?php echo base_url()?>img/watchfilms/slider-home.jpg');background-size:100% auto;">&nbsp;</div>
                </div>
                <div class="item">
                    <div class="img-src" style="background-image: url('<?php echo base_url()?>img/watchfilms/slider-home.jpg');background-size:100% auto;">&nbsp;</div>
                </div>
            ...
            <div class="slider-nav">
                <span class="slider-nav-item prev" data-carouselid="carousel15"><span class="fa fa-angle-left"></span></span>
                <span class="slider-nav-item next" data-carouselid="carousel15"><span class="fa fa-angle-right"></span></span>
            </div>
        </div>
            ...
            <div class="container" style="width: 100%;">
                <div class="row row-list" style="padding:0;">
                            ...
                            <div class="col-md-10" style="padding-left: 0px;">
                                <div class="owl-theme owl-carousel" id="carousel1">
                                  <?php foreach ($feature->result() as $row){
                                    ...
                                    <div class="item">
                                      <?php //echo $link_open?>
                                      <a href="#" onclick="openmovie('<?php echo $row->id?>','<?php echo $row->category_id?>')">
                                        <div class="hover-element hover-element-1 wow flipInX" <?php echo $popover?> data-wow-delay="0.4s" data-wow-duration="0.6s" data-title-position="top,left" style="cursor:pointer;" name="<?php echo $link?>">
                                            ...
                                            <div class="hover-element__reveal" data-overlay="9">
                                                <div class="boxed" style="padding-top:25%;font-weight:200 !important;">
                                                    <h5 style="font-weight:200 !important;"><?php echo $row->title?></h5>
                                                    <span>
                                ...
                                <div class="owl-theme owl-carousel" id="carousel2">
                                  ...
                                  <?php foreach ($shortfilm->result() as $row){
                                    ...
                                    <div class="item">
                                      ...
                                      <a href="#" onclick="openmovie('<?php echo $row->id?>','<?php echo $row->category_id?>')">
                                        <div class="hover-element hover-element-1 wow flipInX" <?php echo $popover?> data-wow-delay="0.4s" data-wow-duration="0.6s" data-title-position="top,left" style="cursor:pointer;" name="<?php echo $link?>">
                                            <div class="img-film hover-element__initial" style="background:url('<?php echo 'http://116.206.196.146/'.$row->cover?>');background-size:auto 100%;width:100%;height:135px;background-position:top center;background-repeat:no-repeat;background-color:#000;">
                                            <?php if($harga <> 'FREE'){ ?>
                                              <div class="pull-right" style="background:url('<?php echo base_url()?>images/label-harga.png');background-size:100px;width:100%;height:100%;background-position:top right;background-repeat:no-repeat;font-weight:200;font-size:0.9em;">
                                ...
                                <div class="owl-theme owl-carousel" id="carousel3">
                                  <?php foreach ($documentary->result() as $row){
                                    ...
                                    <div class="item">
                                      ...
                                      <a href="#" onclick="openmovie('<?php echo $row->id?>','<?php echo $row->category_id?>')">
                                        <div class="hover-element hover-element-1 wow flipInX" <?php echo $popover?> data-wow-delay="0.4s" data-wow-duration="0.6s" data-title-position="top,left" style="cursor:pointer;" name="<?php echo $link?>">
                                            <div class="img-film hover-element__initial" rel='popover' style="background:url('<?php echo 'http://116.206.196.146/'.$row->cover?>');background-size:auto 100%;width:100%;height:135px;background-position:top center;background-repeat:no-repeat;background-color:#000;">
                                            <?php if($harga <> 'FREE'){ ?>
                                              <div class="pull-right" style="background:url('<?php echo base_url()?>images/label-harga.png');background-size:100px;width:100%;height:100%;background-position:top right;background-repeat:no-repeat;font-weight:200;font-size:0.9em;">
                                                <span class="pull-right" style="-webkit-transform: rotate(47deg);-moz-transform: rotate(47deg);color:white;margin-top: 9%;width: 22%;text-align:center;">
                                                  <?php echo $harga?>
                            ...
                            <div class="col-md-10" style="padding-left: 0px;">
                                <div class="owl-theme owl-carousel" id="carousel4">
                                  <?php foreach ($trailer->result() as $row){
                                    ...
                                    $word_title = str_word_count($row->title,1);
                                    $jum_word_title = count($word_title);
                                    $this->db->select("id,title");
                                    $this->db->from("film_list");
                                    $this->db->where("category_id","2");

                                    for($i=0;$i<$jum_word_title-1;$i++){
                                        $this->db->like("title",$word_title[$i]);
                                    }
                                    $this->db->limit(1);

                                    $data_film = $this->db->get()->result();
                                    if(empty($data_film)){
                                        $row->category_id = 6;
                                    }else{
                                        $link = base_url().'detail/index/'.url_title(strtolower($data_film[0]->title)).'/'.$data_film[0]->id;
                                    }
                                    #print_r($query);
                                    #exit();
                                    #print_r($word_title);
                                ...
                                <div class="owl-theme owl-carousel" id="carousel8">
                                  <?php foreach ($archive->result() as $row){
                                    ...
                                    <div class="item">
                                      ...
                                      <a href="#" onclick="openmovie('<?php echo $row->id?>','<?php echo $row->category_id?>')">
                                        <div class="hover-element hover-element-1 wow flipInX" <?php echo $popover?> data-wow-delay="0.4s" data-wow-duration="0.6s" data-title-position="top,left" style="cursor:pointer;" name="<?php echo $link?>">
                                            <div class="img-film hover-element__initial" rel='popover' style="background:url('<?php echo 'http://116.206.196.146/'.$row->cover?>');background-size:auto 100%;width:100%;height:180px;background-position:top center;background-repeat:no-repeat;background-color:#000;">
                                            <?php if($harga <> 'FREE'){ ?>
                                              <div class="pull-right" style="background:url('<?php echo base_url()?>images/label-harga.png');background-size:100px;width:100%;height:100%;background-position:top right;background-repeat:no-repeat;font-weight:200;font-size:0.9em;">
                                                <span class="pull-right" style="-webkit-transform: rotate(47deg);-moz-transform: rotate(47deg);color:white;margin-top: 9%;width: 22%;text-align:center;">
                                                  <?php echo $harga?>
                    ...
                    <div class="col-md-12 list-item-bottom">
                        ...
                        <div class="list-featured-bottom owl-theme owl-carousel" id="carousel10">
                          <?php foreach ($featured->result() as $row){
                            ...
                            <div class="item">
                                <?php echo $link_open?>
                                  <div class="hover-element hover-element-1 wow flipInX" <?php echo $popover?> data-wow-delay="0.4s" data-wow-duration="0.6s" data-title-position="top,left" style="cursor:pointer;" name="<?php echo $link?>">
                                      <div class="img-film hover-element__initial" rel='popover' style="background:url('<?php echo 'http://116.206.196.146/'.$row->cover?>');background-size:auto 100%;width:100%;height:285px;background-position:top center;background-repeat:no-repeat;background-color:#000;">
                                      <?php if($harga <> 'FREE'){ ?>
                                        <div class="pull-right" style="background:url('<?php echo base_url()?>images/label-harga.png');background-size:100px;width:100%;height:100%;background-position:top right;background-repeat:no-repeat;font-weight:200;font-size:0.9em;">
                        ...
                        <div class="costumNavBottom">
                            <span class="cnav-bottom-item prev" data-carouselid="carousel10">
                                <span class="fa fa-chevron-left"></span>
                            </span>
                            <span class="cnav-bottom-item next" data-carouselid="carousel10">
                                <span class="fa fa-chevron-right"></span>
                            </span>
                        </div>
                    ...
                    <div class="col-md-3" style="padding-left:0px;">
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <?php
                                    }elseif($value->param == "sosmed_linkedin"){
                                ?>
                                    <td>
                                        <a href="<?php echo $value->value?>" target="_blank" class="col-md-3 socround back-fb">
                                ...
                                <?php
                                    }elseif($value->param == "sosmed_mail"){
                                ?>
                                    <td>
                                        <a href="mailto:<?php echo $value->value?>?Subject=Hello%20Id%20Film%20Center" class="col-md-3 socround back-instagram">
    ...
    ?>
    <!-- Modal -->
    <div class="modal fade" id="popup-movie" role="dialog" style="width:800px;top:7%;left:20%;overflow-y: hidden;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="col-md-12" style="text-align:left !important;">
                        <span id="sort_detail" style="font-size:12px;font-weight:200;color:black;"></span>
                    </div>
                    <div class="col-md-12" style="text-align:right !important;">
                        <a href="#" id="link_detail" style="font-size:12px;font-weight:200;color:#D30E0E;">Selengkapnya</a>
                    </div>
                    <div class="col-md-9" style="text-align:left !important;">
                        <div class="col-md-4 gapless" style="padding-right: 5px;text-align:center;">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
           ...
           $('body').popover({
            ...
            $("#search").click(function(){
              ...
              var url_search = '<?php echo base_url()?>watchfilms/index/'+text;
        ...
        function openmovie(idfilm,idcategory){
            $.ajax({
                type : 'POST',
                url : '<?php echo base_url()?>watchfilms/filmdata/'+idfilm,
                success:function(data){
                    ...
                    if(idcategory == '6' || idcategory == '8'){
                        $("#link_detail").attr('style','display:none');
                    }else{
                        $("#link_detail").attr('href', tmp.link_detail);

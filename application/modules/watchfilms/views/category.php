...
?>
    ...
    <nav class="transition--fade" id="nav2">
        <div class="nav-bar nav--absolute nav--fixed" data-fixed-at="200">
            ...
            <div class="nav-module menu-module left">
                <ul class="menu">
                    <li <?php if($category != 22){?>class="active"<?php }?>>
    ...
    $see_more_now_url = str_replace("category","see_more",$now_url);
    $js_see_more = str_replace("category","js_see_more",$now_url);
    ?>
            ...
            <div class="container genre-films" style="width: 100%;">
                <div class="row row-list">
                    ...
                    <div class="tutorial_list">
                            ...
                            <div class="col-md-12 content-film-genre">
                              <div class="col-md-6 content-left-genre">
                                ...
                                <div class="modal-body" style="margin: 0 50px;">
                                        <video id="path-movie" class="video-js" controls  width="597" height="350"
                              ...
                              <div class="col-md-4 content-right-genre">
                                  ...
                                  <div class="genre-detail-button">
                                      <div class="col-md-4 gapless" id="harga1-detail11" style="padding-right: 5px;">
                                      ...
                                      <div class="col-md-4 gapless" id="harga1-detail12" style="padding-right: 5px;">
                                      ...
                                      <div class="col-md-4 gapless" id="harga1-detail13" style="padding-right: 5px;">
                        ...
                        <div id="detail2" class="detailin">
                            <div class="col-md-12 arrow-up"></div>
                            <div class="col-md-12 content-film-genre">
                              <div class="col-md-6 content-left-genre">
                                <!--<img id="thumbnail-video2" style="width: 77%;">-->
                                <div class="modal-body" style="margin: 0 50px;">
                                    <video id="path-movie2" class="video-js" controls  width="597" height="350"
                                    poster="http://116.206.196.146/filmdata/covermovie.jpg" data-setup="{}">
                              ...
                              <div class="col-md-4 content-right-genre">
                                  ...
                                  <div class="genre-detail-button">
                                      <div class="col-md-4 gapless" id="harga1-detail21" style="padding-right: 5px;">
                                          <span style="font-size:12px;font-weight:100;color:white;">Harga Streaming</span>
                                      ...
                                      <div class="col-md-4 gapless" id="harga1-detail22" style="padding-right: 5px;">
                                          <span style="font-size:12px;font-weight:100;color:white;">Harga DVD</span>
                                          <button type="button" class="btn-genre btn-white-grey" id="harga2-detail2" onclick="buyfilm('<?php echo $status?>','dvd')">Rp 15.000</button>
                                      </div>
                                      <div class="col-md-4 gapless" id="harga1-detail23" style="padding-right: 5px;">
                                          <span style="font-size:12px;font-weight:100;color:white;">Harga VCD</span>
                                ...
                                <div class="item" rel="item3" name="<?php echo $row->id?>" style="padding-left: 0px;">
                                  ...
                                  <?php
                                    ...
                                    if (count($matches[0]) > 0) {
                                        $jum_digit = strlen($matches[0][0]);
                                        if($jum_digit == 4){
                                            $digit = $matches[0][0];
                                            $time = substr($digit,0,2)."'".substr($digit,2,2);
                                            $title = str_replace($digit,$time,$row->title);
                                        }
                                    }

                                    ?>
                                    <span class="title" style="font-size:16px;"><?php echo $title?></span><br>
                                    <span class="desc"><?php echo $company_name?></span>
                                  </div>
                                </div>
                              <?php } ?>
                        ...
                        <div id="detail3" class="detailin">
                            <div class="col-md-12 arrow-up"></div>
                            <div class="col-md-12 content-film-genre">
                                <div class="col-md-6 content-left-genre">
                                    <!--<img id="thumbnail-video3" style="width: 77%;">-->
                                <div class="modal-body" style="margin: 0 50px;">
                                    <video id="path-movie3" class="video-js" controls  width="597" height="350"
                                    poster="http://116.206.196.146/filmdata/covermovie.jpg" data-setup="{}">
                                ...
                                <div class="col-md-4 content-right-genre">
                                    ...
                                    <div class="genre-detail-button">
                                        <div class="col-md-4 gapless" id="harga1-detail31" style="padding-right: 5px;">
                                            <span style="font-size:12px;font-weight:100;color:white;">Harga Streaming</span>
                                        ...
                                        <div class="col-md-4 gapless" id="harga1-detail32" style="padding-right: 5px;">
                                            <span style="font-size:12px;font-weight:100;color:white;">Harga DVD</span>
                                            <button type="button" class="btn-genre btn-white-grey" id="harga2-detail3" onclick="buyfilm('<?php echo $status?>','dvd')">Rp 15.000</button>
                                        </div>
                                        <div class="col-md-4 gapless" id="harga1-detail33" style="padding-right: 5px;">
                                            <span style="font-size:12px;font-weight:100;color:white;">Harga VCD</span>
    ...
    <input type="hidden" id="film_category" value="<?php echo $this->uri->segment(3);?>">
          			...
          			success:function(data){
                        ...
                        if(tmp.category_id == '10'){
                            if(tmp.id_full_film != '' && tmp.id_full_film != 0){
                                $("#link-detail1").attr("href", "<?php echo base_url()?>detail/index/"+tmp.url_title+"/"+tmp.id_full_film);
                            }else{
                                $("#link-detail1").attr('style','display:none');
                            }
                        }else{
                            $("#link-detail1").attr("href", "<?php echo base_url()?>detail/index/"+tmp.url_title+"/"+idfilm);
                        }

                        if(film_category == 2){
                            $("#harga1-detail12").attr('style','display:none');
                            $("#harga1-detail13").attr('style','display:none');
                        }else if(film_category == 21){
                            $("#harga1-detail11").attr('style','display:none');
                            if(tmp.harga_dvd == 0){
                                $("#harga1-detail12").attr('style','display:none');
                            }if(tmp.harga_vcd == 0){
                                $("#harga1-detail13").attr('style','display:none');
                        ...
                        if(tmp.category_id == '6' || tmp.category_id == '8' || tmp.category_id == '4'){
                            ...
                            //$("#link-detail1").attr('href', full_film);
                            //$("#link-detail1").attr('href', "<?php echo base_url()?>detail/index/"+tmp.title+"/"+idfilm);
                            $("#link-detail1").attr('style','display:block;font-size:12px;font-weight:200;color:#D30E0E;');
                        }
            ...
            $("[rel='item2']").click(function() {
                ...
                $.ajax({
          			...
          			success:function(data){
                        ...
                        if(tmp.category_id == '10'){
                            if(tmp.id_full_film != '' && tmp.id_full_film != 0){
                                $("#link-detail2").attr("href", "<?php echo base_url()?>detail/index/"+tmp.url_title+"/"+tmp.id_full_film);
                            }else{
                                $("#link-detail2").attr('style','display:none');
                            }
                        }else{
                            $("#link-detail2").attr("href", "<?php echo base_url()?>detail/index/"+tmp.url_title+"/"+idfilm);
                        }

                        if(film_category == 2){
                            $("#harga1-detail22").attr('style','display:none');
                            $("#harga1-detail23").attr('style','display:none');
                        }else if(film_category == 21){
                            $("#harga1-detail21").attr('style','display:none');
                            if(tmp.dvd_price == 0){
                                $("#harga1-detail22").attr('style','display:none');
                            }if(tmp.vcd_price == 0){
                                $("#harga1-detail23").attr('style','display:none');
                        ...
                        if(tmp.category_id == '6' || tmp.category_id == '8' || tmp.category_id == '4'){
                            ...
                            //$("#link-detail2").attr('href', full_film);
                            //$("#link-detail2").attr('href', "<?php echo base_url()?>detail/index/"+tmp.title+"/"+idfilm);
                            $("#link-detail2").attr('style','display:block;font-size:12px;font-weight:200;color:#D30E0E;');
                        }
            ...
            $("[rel='item3']").click(function() {
                ...
                $.ajax({
          			...
          			success:function(data){
                        ...
                        if(tmp.category_id == '10'){
                            if(tmp.id_full_film != '' && tmp.id_full_film != 0){
                                $("#link-detail3").attr("href", "<?php echo base_url()?>detail/index/"+tmp.url_title+"/"+tmp.id_full_film);
                            }else{
                                $("#link-detail3").attr('style','display:none');
                            }
                        }else{
                            $("#link-detail3").attr("href", "<?php echo base_url()?>detail/index/"+tmp.url_title+"/"+idfilm);
                        }

                        if(film_category == 2){
                            $("#harga1-detail32").attr('style','display:none');
                            $("#harga1-detail33").attr('style','display:none');
                        }else if(film_category == 21){
                            $("#harga1-detail31").attr('style','display:none');
                            if(tmp.dvd_price == 0){
                                $("#harga1-detail32").attr('style','display:none');
                            }if(tmp.vcd_price == 0){
                                $("#harga1-detail33").attr('style','display:none');
                        ...
                        if(tmp.category_id == '6' || tmp.category_id == '8' || tmp.category_id == '4'){
                            ...
                            //$("#link-detail3").attr('href', full_film);
                            //$("#link-detail2").attr('href', "<?php echo base_url()?>detail/index/"+tmp.title+"/"+idfilm);
                            $("#link-detail3").attr('style','display:block;font-size:12px;font-weight:200;color:#D30E0E;');
                        }

      ...
      <section class="project-single-process">
        <div class="container" style="width: 100%;margin-top:50px;">
          <div class="row row-list text-center" style="padding-left:155px;padding-right:155px;">
            <div class="title-payment" style="padding-top:20px;">My Profile</div>
            <div class="col-md-12 text-center">
              <div class="box-checkout" style="height:820px;">
                <div class="col-md-12">
                  <?php foreach ($member->result() as $row){ ?>
                  <form class="form-register" method="post" style="margin:0;" enctype="multipart/form-data">
                    <input type="hidden" name="idmember" id="idmember" value="<?php echo $row->id?>">
                    <div class="col-md-4">
                        <img src="<?php echo base_url().$row->picture?>" alt="Profile Picture" style=";margin-left:15px;width:90% !important;">
                        <input class="input-field" type="file" name="picture" id="picture" placeholder="Picture" style="margin-top:0px;margin-right:0px;">
                    </div>
                    <div class="col-md-8">
                        <input class="input-field full-width" type="text" name="email" id="email" value="<?php echo $row->email?>" readonly="" style="margin-top:0px;width:97% !important;">
                    </div>
                    <div class="col-md-8">
                        <input class="input-field full-width" type="text" name="nama" id="nama" value="<?php echo $row->nama?>" placeholder="Nama Lengkap" style="margin-top:0px;width:97% !important;">
                    </div>
                    <div class="col-md-8">
                        <textarea class="input-field full-width" name="alamat" id="alamat" rows="6" placeholder="Alamat Anda" style="margin-top:0px;width:97% !important;"><?php echo $row->alamat?></textarea>
                    </div>
                    <div class="col-md-12">
                        <input class="input-field full-width" type="password" name="password" id="password" placeholder="Isi untuk merubah password anda">
                    </div>
                    <div class="col-md-12">
                        <input class="input-field full-width" type="text" name="telepon" id="telepon" placeholder="Nomor Telepon Anda" value="<?php echo $row->telepon?>">
                    </div>
                    <div class="col-md-6" style="text-align:left;padding-top:25px;padding-right:40px;padding-left:15px;">
                      <a href="<?php echo site_url('transaksi')?>">
                        <button type="button" id="transaksi" class="butt butt-primary sharp" style="font-size:16px !important;width:150px;height:60px;">Daftar Transaksi</button>
                      </a>
                    </div>
                    <div class="col-md-6" style="text-align:right;padding-top:25px;padding-right:8px;">
                      <button type="submit" id="update" class="butt butt-primary sharp" style="font-size:16px !important;width:150px;height:60px;">Update</button>
                    </div>
                  </form>
                  <?php } ?>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
          ...
          $(".form-register").on('submit',function(e){
            ...
            $.ajax({
              type : 'POST',
              url : '<?php echo site_url('profile/submitprofile')?>',
              data : formatData,
              async: false,
              cache: false,
              contentType: false,
              ...
              success:function(data){
                var tmp = eval('('+data+')');
                if (tmp.success){
                  alert("Update data profile berhasil.");

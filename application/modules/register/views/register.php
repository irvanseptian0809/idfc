              ...
              <div class="box-checkout" style="height:750px;">
                <div class="col-md-12">
                  <form class="form-register" method="post">
                    <input class="input-field" type="text" name="email" id="email" placeholder="Email Anda" required="">
                    <input class="input-field" type="text" name="nama" id="nama" placeholder="Nama Lengkap Anda" required="">
                    <input class="input-field" type="password" name="password1" id="password1" placeholder="Kata Sandi Anda" required="">
                    <input class="input-field" type="password" name="password2" id="password2" placeholder="Ulangi Kata Sandi Anda" required="">
                    <div class="fb-connect">Atau langsung dengan: <img src="images/fb-connect-img.png" class="icon-fb"></div>
          ...
          $(".form-register").on('submit',function(e){
            ...
            if(pass1 == pass2){
            	...
            	var formatData = new FormData($(this)[0]);
          		$.ajax({
          			type : 'POST',
          			url : '<?php echo site_url('register/submit/1')?>',
          			data : formatData,
          			async: false,
          			cache: false,
          			contentType: false,
          			...
          			success:function(data){
          				var tmp = eval('('+data+')');
          				if (tmp.success){
                    window.location = "<?php echo site_url('register/informasi')?>/"+tmp.id_tmp;
          				}else{
          					alert("failed");
          				}
          			}
              ...
              alert("Ulangi Password Anda dengan benar.");
            }
        	});

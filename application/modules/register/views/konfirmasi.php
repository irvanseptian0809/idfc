    ...
    <div class="main-container transition--fade" style="background-color:#efefef;">
      <section class="project-single-process">
        <div class="container" style="width: 100%;margin-top:50px;">
          <div class="arrow-register gray-arrow">
            <div class="title-arrow">
              Langkah 1<br>Buat Akun
            </div>
          </div>
          <div class="arrow-register gray-arrow" style="margin-top:150px;">
            <div class="title-arrow">
              Langkah 2<br>Informasi
            </div>
          </div>
          <div class="arrow-register" style="margin-top:300px;">
            <div class="title-arrow">
              Langkah 3<br>Konfirmasi
            </div>
          </div>
          <div class="arrow-register gray-arrow" style="margin-top:450px;">
            <div class="title-arrow">
              Langkah 4<br>Validasi
            </div>
          </div>
          <div class="row row-list text-center" style="padding-left:155px;padding-right:155px;">
            <div class="col-md-12 text-center">
              <div class="box-checkout" style="height:750px;">
                <div class="col-md-12">
                  <form class="form-register" method="post" style="text-align:left;">
                    <h5>Masukkan kode verifikasi yang sudah dikirimkan ke email anda.</h5><br>
                    <input type="hidden" name="email" id="email" value="<?php echo $email?>">
                    <input type="hidden" name="nama" id="nama" value="<?php echo $nama?>">
                    <input type="hidden" name="password" value="<?php echo $password?>">
                    <input type="hidden" name="id_tmp" value="<?php echo $id_tmp?>">
                    <label for="kode_verifikasi" style="font-size:13px;">Kode Verifikasi :</label>
                    <input class="input-field" type="text" name="kode_verifikasi" id="kode_verifikasi" placeholder="Kode Verifikasi" required="">
                    <div class="col-md-12" style="padding-top:25px;padding-right:40px;text-align:left;height:300px;">&nbsp;</div>
                    <div class="col-md-6" style="text-align:left;padding-top:25px;padding-right:40px;">
                      <button type="button" onclick="goBack()" class="butt butt-primary sharp" style="font-size:16px !important;width:150px;height:60px;"><< Kembali</button>
                    </div>
                    <div class="col-md-6" style="text-align:right;padding-top:25px;padding-right:40px;">
                      <button type="submit" id="bayar" class="butt butt-primary sharp" style="font-size:16px !important;width:150px;height:60px;">Lanjutkan >></button>
                    </div>
                  </form>
                </div>
              </div>
            ...
            $(".form-register").on('submit',function(e){
              e.preventDefault();
            	var formatData = new FormData($(this)[0]);
          		$.ajax({
          			type : 'POST',
          			url : '<?php echo site_url('register/submit/2')?>',
          			data : formatData,
          			async: false,
          			cache: false,
          			contentType: false,
          			...
          			success:function(data){
          				var tmp = eval('('+data+')');
          				if (tmp.success){
                    window.location = "<?php echo site_url('register/validasi')?>/"+tmp.id_tmp;
          				}else{
          					alert("Maaf, kode yang anda masukkan salah / tidak sesuai.");
          				}
          			}
          		});
          	});

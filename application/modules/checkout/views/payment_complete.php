                    ...
                    <div class="box-checkout">
                        <table class="table-checkout">
                          <tr>
                            ...
                            <th width="20%" class="head-table-checkout">Jumlah</th>
                          </tr>
                          <tr>
                            <td colspan="6"><hr></td>
                          </tr>
                          <?php 
                            ...
                            $satuan = round($row->price/$kurs, 2);
                            $total_satuan = round($row->price * $row->count/$kurs, 2);

                            $total = $total + $satuan * $total_satuan;
                          ?>
                          <tr class="item">
                            ...
                            <td>
                              <span style="padding-left:20px;padding-right:20px;"><?php echo $row->count?></span>
                            </td>
                            <td>$ <?php echo $total_satuan?></td>
                          </tr>
                          <?php }?>
                          ...
                          <tr>
                            ...
                            <th colspan="2" class="total-footer" style="font-size: 18px;">$ <?php echo number_format($total,2)?></th>
                          </tr>
                        </table>
                    </div>

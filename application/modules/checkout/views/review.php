                        ...
                        <div class="col-md-4 column">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>$<?php echo number_format($cart['shopping_cart']['grand_total_usd'],2); ?></td>
                                </tr>
                                <tr>
                                    <td class="center" colspan="2">
                                        <a class="btn btn-primary btn-block" href="<?php echo site_url('checkout/DoExpressCheckoutPayment/'.$id.'/'.$paypal_payer_id); ?>">Complete Order</a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>

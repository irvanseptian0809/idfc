...
<?php if($condition == 'normal'){?>
                    ...
                    <div class="col-md-12 list-item-gray segera-tayang-margin" style=""><!--kerjaan bayu margin-left:17px;width:1298px;-->
                        <div class="col-md-12" style="margin-left:5px;"><!--padding-left:170px;padding-right:180px;-->
                            <div class="col-md-3">
                                <?php if($lang == "en"){?>
...
<?php }?>
<?php if($getcategory == "profile" || $getcategory == "company"){?>
                    <div class="col-md-12 list-item-gray">
                        <div class="col-md-12" style="padding-left:170px;padding-right:180px;">
                            ...
                            <div class="col-md-12" style="padding-left: 0px;">
                                ...
                                <?php }?>
                                        ...
                                        <?php if($getcategory == "profile"){?>
                                            ...
                                            <div class="img-film hover-element__initial" style="background:url('<?php if(!empty($row->photo)){
                                        ...
                                        <?php }else{?>
                                            ...
                                            <div class="img-film hover-element__initial" style="background:url('<?php if(!empty($row->logo)){
                                                if(strpos($row->logo, 'uploads/') !== false){
                                                    echo 'http://116.206.196.146/'.$row->logo;
                                                }else if(strpos($row->logo, 'filmdata/') !== false){
                                                    echo 'http://116.206.196.146/'.$row->logo;
                                                }else{
                            ...
                            <div class="col-md-12" style="padding-left: 0px;">
                                ...
                                <?php
                                foreach (array_slice($data,12) as $row){
                                $break++;
                                if($break>21){break;}
                                ?>
                                    <div class="item" style="padding:10px;">
                                ...
                                <?php foreach ($company->result() as $row){?>
                                    ...
                                    <a href="<?php echo site_url('profil/index/company/'.$row->id)?>">
                                        <div class="hover-element hover-element-1 text-center wow flipInX" <?php //echo $popover?> data-wow-delay="0.4s" data-wow-duration="0.6s" data-title-position="top,left" style="cursor:pointer;" name="<?php //echo $link?>">
                                            ...
                                            }else{echo 'http://116.206.197.44/img/user-demo.png';}?>');background-size:100% auto;width:100%;height:115px;border-radius: 50%;">
                                            </div>
                                        </div>
                                        <div class="bottom-caption text-center" style="margin-top:5px;">
                                            <span class="title" style="font-size:16px;"><?php echo $row->title?></span><br>
